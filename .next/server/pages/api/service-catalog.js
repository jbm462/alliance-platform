...
Format the output as a professional report suitable for executive presentation.`,created_at:r,updated_at:r}],{error:d}=await i.O.from("workflow_steps").insert(n);if(d)throw d;return{workflowId:a,steps:n}}catch(e){throw console.error("Error creating service catalog workflow:",e),e}};r()}catch(e){r(e)}})},4217:(e,t,a)=>{a.d(t,{O:()=>s});let r=require("@supabase/supabase-js"),o="https://rpudkaqdoguytyweytww.supabase.co",i="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJwdWRrYXFkb2d1eXR5d2V5dHd3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgxNDI3NTMsImV4cCI6MjA2MzcxODc1M30.GWu-jUQXMU94kTuGx9aK5aG_xNVjJFq9lbrcLUW8HBA";if(!o||!i)throw Error("Missing Supabase environment variables");let s=(0,r.createClient)(o,i,{auth:{persistSession:!1,autoRefreshToken:!1},global:{fetch:fetch}})},970:(e,t,a)=>{a.a(e,async(e,r)=>{try{a.r(t),a.d(t,{default:()=>handler});var o=a(678),i=e([o]);async function handler(e,t){if("POST"!==e.method)return t.status(405).json({message:"Method not allowed"});let a={user:{id:"demo-user-123"}};if(!a||!a.user?.id)return t.status(401).json({message:"Unauthorized"});try{let{category:r}=e.body;if(!r)return t.status(400).json({message:"Category is required"});let i=await (0,o.U)(a.user.id,r);return t.status(201).json({message:"Service catalog workflow created successfully",workflowId:i.workflowId})}catch(e){return console.error("Error creating service catalog workflow:",e),t.status(500).json({message:"Failed to create service catalog workflow"})}}o=(i.then?(await i)():i)[0],r()}catch(e){r(e)}})}};var t=require("../../webpack-api-runtime.js");t.C(e);var __webpack_exec__=e=>t(t.s=e),a=t.X(0,[222],()=>__webpack_exec__(5911));module.exports=a})();